...
namespace Checador_Alumnos
{
...

    {
        ...
        //private VideoCaptureDevice FuenteDeEscaner;
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            timer1.Enabled = true;
            timer1.Start();
            //FuenteDeEscaner = new VideoCaptureDevice(Dispositivos[comboBox1.SelectedIndex].MonikerString);
           // videoSourcePlayer1.VideoSource = FuenteDeEscaner;
